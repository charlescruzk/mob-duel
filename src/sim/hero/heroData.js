...
export const HEROES = {
  bayani: {
    ...
    passive: {
      key: 'p', name: 'Anting-Anting', kind: 'lifeOnHit',
      desc: 'Each basic attack that lands heals 6 + 2/level (x3 vs heroes).',
      heal: { base: 6, step: 2 }, heroMult: 3,
    },
    abilities: {
      q: {
        slot: 'q', name: 'Kampilan Sweep', cost: 40, cd: 6.0, range: 0, shape: 'selfAoe',
        radius: 3.0, damage: { base: 60, step: 15 }, slowPct: 0.30, slowTime: 1.0,
        desc: 'Instant circle r3 around Bayani. Damage, 30% slow 1 s.',
      },
      w: {
        slot: 'w', name: 'Kalasag Guard', cost: 50, cd: 14.0, range: 0, shape: 'shield',
        shield: { base: 90, step: 25 }, duration: 3.0,
        desc: 'Shield for 3 s. Recast refreshes.',
      },
      e: {
        slot: 'e', name: 'Datu\'s Charge', cost: 55, cd: 11.0, range: 6.0, shape: 'dash',
      ...
      r: {
        slot: 'r', name: 'Earthshaker Stomp', cost: 100, cd: 60.0, range: 0, shape: 'windup',
  ...
  ren: {
    ...
    passive: {
      key: 'p', name: 'Foxfire Mark', kind: 'mark',
    ...
    abilities: {
      q: {
        slot: 'q', name: 'Kitsunebi', cost: 45, cd: 5.0, range: 11.0, shape: 'skillshot',
        radius: 0.5, speed: 18.0, pierce: false, damage: { base: 70, step: 20 },
        desc: 'Skillshot, 11 m, stops at the first enemy hit.',
      },
      w: {
        slot: 'w', name: 'Fox Ring', cost: 60, cd: 9.0, range: 8.0, shape: 'groundAoe',
      ...
      e: {
        slot: 'e', name: 'Nine-Tail Flicker', cost: 50, cd: 14.0, range: 4.5, shape: 'blink',
        distance: 4.5, hastePct: 0.30, hasteTime: 1.5,
        desc: 'Blink 4.5 m toward the reticle, then +30% move speed for 1.5 s.',
      },
      r: {
        slot: 'r', name: 'Spirit Lance', cost: 110, cd: 55.0, range: 16.0, shape: 'windup',
  ...
  kazane: {
    ...
    abilities: {
      ...
      w: {
        slot: 'w', name: 'Wind Volley', cost: 45, cd: 12.0, range: 0, shape: 'buff',
      ...
      e: {
        slot: 'e', name: 'Feather Hop', cost: 35, cd: 9.0, range: 3.5, shape: 'dash',
      ...
      r: {
        slot: 'r', name: 'Mountain Wind Shot', cost: 100, cd: 70.0, range: 30.0, shape: 'windup',
  ...
  lilit: {
    ...
    abilities: {
      ...
      e: {
        slot: 'e', name: 'Talon Sweep', cost: 40, cd: 7.0, range: 4.5, shape: 'cone',
        arc: 60, damage: { base: 60, step: 16 }, slowPct: 0.20, slowTime: 1.0,
        desc: '60° cone, 4.5 m: damage and 20% slow 1 s.',
      },
      r: {
        slot: 'r', name: 'Feast', cost: 90, cd: 60.0, range: 5.0, shape: 'targeted',
  ...
  oroku: {
    ...
    abilities: {
      ...
      e: {
        slot: 'e', name: 'Rampage', cost: 55, cd: 12.0, shape: 'dash',
      ...
      r: {
        slot: 'r', name: 'Mountain Splitter', cost: 100, cd: 65.0, range: 0, shape: 'windup',
  ...
  amihan: {
    ...
    armor: { base: 0.08, step: 0.01 },
    passive: {
      key: 'p', name: 'Monsoon Step', kind: 'riptide',
      desc: 'Landing any ability grants +15% move speed for 1.5 s.',
      hastePct: 0.15, hasteTime: 1.5,
    },
    abilities: {
      q: {
        slot: 'q', name: 'Vine Snare', cost: 50, cd: 9.0, range: 10.0, shape: 'skillshot',
      ...
      w: {
        slot: 'w', name: 'Healing Chant', cost: 60, cd: 11.0, range: 0, shape: 'heal',
        heal: { base: 80, step: 28 }, hotRate: { base: 20, step: 5 }, hotTime: 3.0,
        desc: 'Heal self 80 instantly, then 20 per second for 3 s.',
      },
      e: {
        slot: 'e', name: 'Riptide Pull', cost: 65, cd: 12.0, range: 7.0, shape: 'groundAoe',
      ...
      r: {
        slot: 'r', name: 'Rain Chant', cost: 120, cd: 70.0, range: 6.0, shape: 'groundAoe',
        ...
        desc: 'Ground circle r5 at the reticle (6 m): a 3.5 s tide that slows enemies '
          + 'inside by 50% and deals damage every 0.5 s, while healing Amihan 3% max HP '
...
export const HERO_KEYS = ['bayani', 'ren', 'kazane', 'lilit', 'oroku', 'amihan'];

// Bayani ↔ Ren for the original pairing; every other hero bot-fills as Bayani until
// hero select (Task 7) wires ?enemy=.
export function otherHero(key) { return key === 'bayani' ? 'ren' : 'bayani'; }
